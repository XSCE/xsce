...
"Undoes the damage done by symlink-tree.py, as best it can. For each file in src, looks for the corresponding symlink in dst and, if it finds it, removes the symlink and copies the file at src to dst. This makes src safe to uninstall."
