...
?>
<?php service_link("rachel", "RACHEL", "RACHEL is a collection of some of the most important material on the internet, such as the Wikipedia, stored locally where you can reach it easily."); ?>
<?php service_link("iiab", "Internet In A Box", "Internet-in-a-Box is also a copy of some of the most important material on the internet, such as the Open Street Maps, stored locally where you can reach it easily."); ?>
